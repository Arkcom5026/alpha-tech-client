        ...
        <table className="min-w-full text-sm">
          ...
          <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
            ...
            {branches.map((branch, index) => (
              <tr key={branch.id || index} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/30 transition-colors">
                ...
                <td
                  className="px-4 py-3.5 text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-sm truncate"
                  title={branch.address}
                >
                  {branch.address || 'ไม่ได้ระบุข้อมูลที่อยู่ทางพิกัด'}
                </td>
