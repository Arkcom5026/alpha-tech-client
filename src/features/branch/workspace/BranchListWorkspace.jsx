...
const BranchListWorkspace = ({
  ...
  <div className="w-full mt-4 animate-fadeIn space-y-4">
    <div className="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm rounded-2xl overflow-hidden">
      <div className="px-5 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-gradient-to-r from-emerald-50/70 via-white to-white dark:from-emerald-950/20 dark:via-zinc-900 dark:to-zinc-900 sticky top-0 z-10">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-black text-zinc-900 dark:text-zinc-100">
        ...
        <div className="w-full max-w-lg bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-2xl shadow-xl flex flex-col overflow-hidden">
          ...
          <form onSubmit={onSubmit} className="p-5 space-y-4">
            ...
            <div>
              ...
              <textarea rows={3} {...register('address', { required: 'กรุณากรอกที่อยู่' })} className="w-full border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 rounded-xl px-3 py-2 text-xs text-zinc-800 dark:text-zinc-100 font-medium leading-relaxed focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 focus:outline-none transition" placeholder="ระบุเลขที่ ถนน ตำบล อำเภอ จังหวัด..." />
            ...
            <div className="pt-2 flex justify-end gap-2">
              ...
              <button type="submit" className="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-black rounded-xl flex items-center gap-1 shadow-sm transition focus:outline-none focus:ring-4 focus:ring-emerald-100">
                <Save className="w-3.5 h-3.5" /><span>บันทึกการแก้ไข</span>
              </button>
            </div>
          </form>
        </div>
...
export default BranchListWorkspace;
