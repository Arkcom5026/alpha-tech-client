...
export const updateConsolidatedDeliveryDocumentLines = async ({ id, lines }) => (
  await apiClient.put(`/combined-billing/consolidated-deliveries/${id}/document-lines`, { lines })
).data;
