...
const Field = ({ label, value, accent = false }) => (
  <div className={`rounded-2xl border p-4 ${accent ? 'border-emerald-200 bg-emerald-50' : 'border-slate-100 bg-slate-50'}`}>
  ...
  return (
    <>
      ...
      <ConfirmActionDialog
        ...
        title="ปิดใช้งาน Product Template"
        description="Operational Product ของสาขาจะไม่ถูกแก้ไข แต่ Template นี้จะไม่พร้อมใช้งานเป็นแหล่งอ้างอิงใหม่จนกว่าจะเปิดใช้งานอีกครั้ง"
