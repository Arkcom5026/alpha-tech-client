  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow min-w-[390px]">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-3 md:gap-4">
        ...
        >
          {customerLoading ? 'กำลังตรวจสอบ...' : 'ค้นหา'}
        </button>
      </div>
        ...
        <div className="mt-2 text-lg text-black bg-white border rounded px-3 py-2 space-y-3">
          ...
          <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
            <div className="col-span-2">
              <label className="block text-lg font-medium text-black mb-1">ประเภทลูกค้า:</label>
            ...
            {customerType === 'นิติบุคคล' && (
              <>
                <input
                  ...
                  className="border px-2 py-1 rounded col-span-2 text-black text-lg"
                />
                <input
                  type="text"
            ...
            {!email && (
              <p className="text-lg text-gray-500 italic col-span-2">
