    ...
    <div className="space-y-6 animate-fadeIn">
      <div className="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div><div className="flex items-center gap-2"><LayoutTemplate className="h-5 w-5 text-emerald-600" /><h1 className="text-xl font-black tracking-tight text-slate-900">รูปแบบเอกสาร</h1></div><p className="mt-1 text-xs font-bold leading-relaxed text-slate-400">กำหนดหัวเอกสารและรูปแบบเฉพาะของ {branch.name || 'ร้านปัจจุบัน'} โดยไม่เปลี่ยนข้อมูลทางกฎหมายของผู้ออกเอกสารภาษี</p></div>
