...
const ScanBarcodeListPage = () => {
  ...
  const handleSaveEditSN = async (row) => {
    ...
    if (!nextSN) {
      setPageMessage({ type: 'error', text: 'กรุณาระบุ SN ที่ต้องการบันทึก' });
      return;
    }
