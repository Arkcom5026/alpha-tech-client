...
const nonPublicCapabilityPayload = (payload = {}) =>
  Object.fromEntries(Object.entries(payload).filter(([key]) => key !== 'storefrontEnabled'));
...
export const savePartnerStoreCapability = async (payload) =>
  unwrap(await apiClient.put('/partner-store/capability', nonPublicCapabilityPayload(payload)));
