...
const SupplierViewWorkspace = () => {
  ...
  if (loading) {
    return <div className="text-center py-12 font-bold text-slate-400 italic">⏳ กำลังเรียกถอดสลักข้อมูลพาร์ตเนอร์คู่ค้า...</div>;
  }
    ...
    <div className="max-w-4xl mx-auto p-2 md:p-4 space-y-3 animate-fadeIn text-xs md:text-sm">
      <div className="bg-white border border-slate-200 p-3 rounded-xl shadow-sm flex items-center justify-between gap-2 select-none">
        ...
        <div className="flex items-center gap-1.5">
          <button
            type="button"
            onClick={() => navigate(paths.edit(id))}
...
export default SupplierViewWorkspace;
