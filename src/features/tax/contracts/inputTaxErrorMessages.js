export const INPUT_TAX_ERROR_MESSAGES_TH = Object.freeze({
  ...
  INPUT_TAX_FILING_VAT_AUTHORITY_REQUIRED: 'ยังเลือกเอกสารเข้ายื่นไม่ได้ เนื่องจากยังไม่มีรายการภาษีซื้อที่อนุมัติเป็นข้อมูลอ้างอิง',
  INPUT_TAX_FILING_VAT_AUTHORITY_CONFLICT: 'ยอดภาษีซื้อที่อนุมัติไม่ตรงกับเอกสาร กรุณาตรวจสอบข้อมูลก่อนยื่น',
  ...
  TAX_PERIOD_INPUT_FILING_INCOMPLETE: 'ยังล็อกงวดไม่ได้ เนื่องจากรายการภาษีซื้อที่ต้องยื่นยังถูกเลือกเข้าชุดยื่นไม่ครบ',
  TAX_PERIOD_INPUT_FILING_NOT_SUBMITTED: 'ยังยื่นงวดภาษีไม่ได้ เนื่องจากชุดยื่นภาษีซื้อของงวดนี้ยังไม่ได้ส่ง',
