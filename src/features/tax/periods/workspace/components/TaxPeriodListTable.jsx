                ...
                <tr key={period.id} className="align-top hover:bg-slate-50/70">
                  ...
                  <td className="px-4 py-4">
                    <div className="flex flex-wrap justify-end gap-2">
                      ...
                      <button type="button" onClick={() => navigate(`${period.id}/accounting-office`)} className="inline-flex items-center gap-1.5 rounded-lg border border-emerald-300 bg-emerald-50 px-3 py-2 text-xs font-bold text-emerald-800 hover:bg-emerald-100"><FolderArchive size={14} /> ส่งสำนักงานบัญชี</button>
