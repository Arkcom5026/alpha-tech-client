        ...
        <>
          ...
          <section className="grid gap-4 2xl:grid-cols-[minmax(0,1fr)_320px]">
            <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
              <div className="grid grid-cols-[80px_150px_1.4fr_1fr_1fr_150px] gap-3 border-b border-slate-100 bg-slate-50 px-4 py-3 text-[11px] font-black uppercase tracking-[0.1em] text-slate-500">
              ...
              {loading && candidates.length === 0 ? (
                ...
                <div className="divide-y divide-slate-100">
                  {candidates.map((candidate) => (
                    <button key={candidate.id} type="button" onClick={() => navigate(`${detailBasePath}/${candidate.id}`)} className="grid w-full grid-cols-[80px_150px_1.4fr_1fr_1fr_150px] gap-3 px-4 py-4 text-left transition hover:bg-orange-50/60">
            ...
            <aside className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <div className="mt-4 space-y-3">
                {reviewerWorkload.length === 0 ? (
                  ...
                  <button key={item.reviewerId} type="button" onClick={() => applyFilters({ ...filters, reviewerId: String(item.reviewerId), page: 1 })} className="w-full rounded-2xl border border-slate-200 p-4 text-left transition hover:border-orange-300">
