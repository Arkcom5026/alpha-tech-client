...
const CandidateDetailHeader = ({ candidate, statusLabel, onBack }) => (
  <>
    <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <button type="button" onClick={onBack} className="min-h-11 rounded-2xl border border-slate-200 px-4 text-xs font-black text-slate-600 hover:border-emerald-300 hover:text-emerald-700">
        ← กลับ Review Queue
      </button>
