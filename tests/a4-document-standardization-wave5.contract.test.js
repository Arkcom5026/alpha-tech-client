...
assert(batch.includes('@page { margin: 2mm; size: A4; }'), 'Barcode batch must keep its 2mm A4 label geometry.')
assert(preview.includes('margin: 2mm') && preview.includes('size: A4'), 'Barcode preview must keep its 2mm A4 label geometry.')
