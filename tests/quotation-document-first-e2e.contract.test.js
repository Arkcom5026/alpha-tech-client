...
includes(printPage, '112 - occupied', 'Quotation table must extend close to the delivery-note settlement baseline');
...
includes(printPage, 'quotation-settlement grid min-h-[27mm]', 'Terms and totals must form one stable footer row attached to the item table');
