...
includes(editor, 'ยอดรวมสินค้า', 'Quotation intake totals must show gross item value');
includes(editor, 'ส่วนลดรายการ', 'Quotation intake totals must show line-level discount impact');
includes(editor, 'ส่วนลดท้ายบิล', 'Quotation intake totals must show document-level discount impact');
