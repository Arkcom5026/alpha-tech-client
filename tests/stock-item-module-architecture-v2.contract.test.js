...
describe('StockItem module architecture v2 contract', () => {
  it('retires the broad API facade and compatibility store while preserving owned slice boundaries', () => {
  ...
  it('documents the receive store boundary cutover and compatibility store retirement', () => {
