...
import {
  SERVER_RENDERER_AUTHORITY,
  renderSaleReceipt80mmHtml,
} from '../src/saleReceipt80mmHtmlRenderer.js'
...
test('ports the certified server sale receipt 80mm renderer contract', () => {
  assert.deepEqual(SERVER_RENDERER_AUTHORITY, {
    repository: 'Arkcom5026/alpha-tech-server',
    path: 'src/modules/storeDevice/print/render/saleReceipt80mmHtmlRenderer.js',
    blobSha: '18852c9d971ac838775b0a83904a242eca275bc3',
  })
...
test('preserves server fail-closed projection authority', () => {
  assert.throws(
